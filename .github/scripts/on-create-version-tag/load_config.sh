...
load_server_config() {
    ...
    export_to_github_env "RECRUITAI_TG_BOT_PREFIX" "$RECRUITAI_TG_BOT_PREFIX"
    export_to_github_env "RECRUITAI_ACCOUNT_PREFIX" "$RECRUITAI_ACCOUNT_PREFIX"
    export_to_github_env "RECRUITAI_AUTHORIZATION_PREFIX" "$RECRUITAI_AUTHORIZATION_PREFIX"
    export_to_github_env "RECRUITAI_EMPLOYEE_PREFIX" "$RECRUITAI_EMPLOYEE_PREFIX"
    export_to_github_env "RECRUITAI_ORGANIZATION_PREFIX" "$RECRUITAI_ORGANIZATION_PREFIX"
    export_to_github_env "RECRUITAI_CONTENT_PREFIX" "$RECRUITAI_CONTENT_PREFIX"
    export_to_github_env "RECRUITAI_RELEASE_TG_BOT_PREFIX" "$RECRUITAI_RELEASE_TG_BOT_PREFIX"
    export_to_github_env "RECRUITAI_INTERSERVER_SECRET_KEY" "$RECRUITAI_INTERSERVER_SECRET_KEY"
    ...
    echo "  • TG Bot:         $RECRUITAI_TG_BOT_PREFIX"
    echo "  • Account:        $RECRUITAI_ACCOUNT_PREFIX"
    echo "  • Authorization:  $RECRUITAI_AUTHORIZATION_PREFIX"
    echo "  • Employee:       $RECRUITAI_EMPLOYEE_PREFIX"
    echo "  • Organization:   $RECRUITAI_ORGANIZATION_PREFIX"
    echo "  • Content:        $RECRUITAI_CONTENT_PREFIX"
    echo "  • Release Bot:    $RECRUITAI_RELEASE_TG_BOT_PREFIX"
    echo ""
}