...
refresh_all_databases() {
    ...
    local services=(
        "$RECRUITAI_TG_BOT_PREFIX:TG Bot"
        "$RECRUITAI_ACCOUNT_PREFIX:Account"
        "$RECRUITAI_AUTHORIZATION_PREFIX:Authorization"
        "$RECRUITAI_EMPLOYEE_PREFIX:Employee"
        "$RECRUITAI_ORGANIZATION_PREFIX:Organization"
        "$RECRUITAI_CONTENT_PREFIX:Content"
    )
